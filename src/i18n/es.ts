...
const spanishMessages: Required<TranslationMessages> = {
  ra: {
    ...
    message: {
        ...
        access_denied: "Acceso denegado",
        authentication_error: "Error de autenticación",
        select_all_limit_reached: "select_all_limit_reached",
        placeholder_data_warning: "placeholder_data_warning"
    },
    navigation: {
        ...
        no_filtered_results: "No hay coincidencias",
