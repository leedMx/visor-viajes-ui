...
// Whenever a dataProvider request includes a "search" filter, 
// this dataProvider will re-route the request to baseUrl/{search value}
...
// Used if a resource URL needs to be mapped to a specific search endpoint 
// and cannot explictly include the search param like in getManyReference 
// needs to be mapped to resource name
